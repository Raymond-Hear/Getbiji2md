...
4. 保存设置
5. 第一次点击“同步过去所有笔记”，把历史笔记拉到当前浏览器
6. 后续需要刷新时，点击“同步最近笔记”检查新增内容
...
- 第一次使用时，工具会显示“同步过去所有笔记”，用于整理你之前的历史内容。
- 本地已经有同步结果后，按钮会切换成“同步最近笔记”，优先检查新增内容。
- 这样做可以减少重复请求，避免每次都从头重新拉取全部历史笔记。
